 ...
 */
public class MatsumotoTela extends javax.swing.JDialog implements Observador {

    /**
     * Creates new form MatsumotoTela
     */
    Controle controle;

    public MatsumotoTela(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MatsumotoTela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MatsumotoTela dialog = new MatsumotoTela(new javax.swing.JFrame(), true);
