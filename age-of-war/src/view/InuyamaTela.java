 ...
 */
public class InuyamaTela extends javax.swing.JDialog implements Observador {

    /**
     * Creates new form InuyamaTela
     */
    Controle controle;

    public InuyamaTela(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InuyamaTela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InuyamaTela dialog = new InuyamaTela(new javax.swing.JFrame(), true);
