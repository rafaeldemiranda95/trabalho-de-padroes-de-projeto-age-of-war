 ...
 */
public class KasugayamaTela extends javax.swing.JDialog implements Observador {

    /**
     * Creates new form KasugayamaTela
     */
    Controle controle;

    public KasugayamaTela(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KasugayamaTela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                KasugayamaTela dialog = new KasugayamaTela(new javax.swing.JFrame(), true);
