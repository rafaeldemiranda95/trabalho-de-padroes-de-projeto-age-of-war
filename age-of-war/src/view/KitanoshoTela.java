 ...
 */
public class KitanoshoTela extends javax.swing.JDialog implements Observador {

    /**
     * Creates new form KitanoshoTela
     */
    Controle controle;

    public KitanoshoTela(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KitanoshoTela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                KitanoshoTela dialog = new KitanoshoTela(new javax.swing.JFrame(), true);
