 ...
 */
public class MatsuyamaTela extends javax.swing.JDialog implements Observador {

    /**
     * Creates new form MatsuyamaTela
     */
    Controle controle;

    public MatsuyamaTela(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MatsuyamaTela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MatsuyamaTela dialog = new MatsuyamaTela(new javax.swing.JFrame(), true);
