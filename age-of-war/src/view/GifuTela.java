 ...
 */
public class GifuTela extends javax.swing.JDialog implements Observador {

    /**
     * Creates new form GifuTela
     */
    Controle controle;

    public GifuTela(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GifuTela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GifuTela dialog = new GifuTela(new javax.swing.JFrame(), true);
