 ...
 */
public class MarugameTela extends javax.swing.JDialog implements Observador {

    /**
     * Creates new form MarugameTela
     */
    Controle controle;

    public MarugameTela(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MarugameTela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MarugameTela dialog = new MarugameTela(new javax.swing.JFrame(), true);
