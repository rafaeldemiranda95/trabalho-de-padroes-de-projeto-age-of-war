 ...
 */
public class OdaniTela extends javax.swing.JDialog implements Observador {

    /**
     * Creates new form OdaniTela
     */
    Controle controle;

    public OdaniTela(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OdaniTela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                OdaniTela dialog = new OdaniTela(new javax.swing.JFrame(), true);
