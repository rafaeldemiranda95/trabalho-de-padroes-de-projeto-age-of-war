 ...
 */
public class EdoTela extends javax.swing.JDialog implements Observador {

    /**
     * Creates new form EdoTela
     */
    Controle controle;

    public EdoTela(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EdoTela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EdoTela dialog = new EdoTela(new javax.swing.JFrame(), true);
